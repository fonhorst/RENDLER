from HeftHelper import HeftHelper
from BaseElements import Node
from ResourceManager import Schedule, ScheduleItem
from Utility import timing
from simple_heft import StaticHeftPlanner
...
def run_heft(workflow, resource_manager, estimator, fixed_schedule=None):
    """
    ...
    init_schedule = Schedule({node: [] for node in nodes}) if fixed_schedule is None else fixed_schedule
